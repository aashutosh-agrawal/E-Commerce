...
$con->query($w6);
$w7 = "insert into menwear values('mwc1p3ss', 'assets/15.jpeg', 'Solid Men Round Neck Red T-Shirt', '700', 'S',  '1100', 'The purple tree Men's Printed Cotton T-Shirt - 1 pc, Printed Cotton Tshirt for Men, Men Tshirt, Tshirt.')";
$con->query($w7);
$w8 = "insert into menwear values('mwc1p3sm', 'assets/15.jpeg', 'Solid Men Round Neck Red T-Shirt', '700', 'M', '1100', 'The purple tree Men's Printed Cotton T-Shirt - 1 pc, Printed Cotton Tshirt for Men, Men Tshirt, Tshirt.')";
$con->query($w8);
$w9 = "insert into menwear values('mwc1p3sl', 'assets/15.jpeg', 'Solid Men Round Neck Red T-Shirt', '700', 'L', '1100', 'The purple tree Men's Printed Cotton T-Shirt - 1 pc, Printed Cotton Tshirt for Men, Men Tshirt, Tshirt.')";
$con->query($w9);
...
$con->query($w12);
$w13 = "insert into menwear values('mwc2p2ss', 'assets/17.jpeg', 'Men Solid Formal Spread Shirt', '2000', 'S', '1100', 'Fashion Mesh Mens See Through Shirts Men Shirt Silk Sexy Floral Men's Casual Shirt long Sleeve Man Shirts Slim Fit Designer Dress.')";
$con->query($w13);
$w14 = "insert into menwear values('mwc2p2sm', 'assets/17.jpeg', 'Men Solid Formal Spread Shirt', '2000', 'M', '1100', 'Fashion Mesh Mens See Through Shirts Men Shirt Silk Sexy Floral Men's Casual Shirt long Sleeve Man Shirts Slim Fit Designer Dress.')";
$con->query($w14);
$w15 = "insert into menwear values('mwc2p2sl', 'assets/17.jpeg', 'Men Solid Formal Spread Shirt', '2000', 'L', '1100', 'Fashion Mesh Mens See Through Shirts Men Shirt Silk Sexy Floral Men's Casual Shirt long Sleeve Man Shirts Slim Fit Designer Dress.')";
$con->query($w15);
$w16 = "insert into menwear values('mwc2p3ss', 'assets/18.jpeg', 'Men Self Design Formal Spread Shirt', '1000', 'S', '1100', 'Men's White Oxford Shirt in Stretch New Men's Shirts men Casual slim fit designer Print Camisa red/khaki/white/green Asian.')";
$con->query($w16);
$w17 = "insert into menwear values('mwc2p3sm', 'assets/18.jpeg', 'Men Self Design Formal Spread Shirt', '1000', 'M', '1100', 'Men's White Oxford Shirt in Stretch New Men's Shirts men Casual slim fit designer Print Camisa red/khaki/white/green Asian.')";
$con->query($w17);
$w18 = "insert into menwear values('mwc2p3sl', 'assets/18.jpeg', 'Men Self Design Formal Spread Shirt', '1000', 'L', '1100', 'Men's White Oxford Shirt in Stretch New Men's Shirts men Casual slim fit designer Print Camisa red/khaki/white/green Asian.')";
$con->query($w18);
