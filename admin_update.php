...
<body>
<h1><center>UPDATE ASSETS</center></h1>
<!-- Page Header start-->
<div class="container-fluid">
<div class="row" style="margin-top:100px;">
<div class="col-md-3"></div>
<div class="col-md-6">
<form action="backend/update_check.php" method="POST" enctype="multipart/form-data">
<div class="form-group">
 ...
 <input type="submit" value="UPDATE" name="asset_update" class="btn btn-success">
</form>
</div>
<div class="col-md-3"></div>
